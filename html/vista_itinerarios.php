...
<head>
  ...
  <title>Itinerarios - Viajamos!</title>
  ...
  <link rel="stylesheet" href="../css/vista_itinerarios.css">
</head>
...
<body>
  ...
  <div class="container my-5">
    <h1 class="mb-4">ITINERARIOS</h1>
    <div class="botones-superiores">
      <a class="btn btn-custom-blue-crear" data-bs-toggle="modal" data-bs-target="#formularioItinerarios">Crear itinerario</a>
  ...
  <!-- Incluir el modal de creación de itinerarios -->
