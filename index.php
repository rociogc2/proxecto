...
<body>
  <!-- Menú -->
  <div id="menu"></div>
  <main class="flex-grow-1 d-flex flex-column justify-content-center align-items-center text-center text-white">
    <h2 class="display-4 fw-bold">Planifica tus aventuras y guarda tus viajes en un solo lugar</h2>
